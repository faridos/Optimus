...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrontOfficeOptimusBundle:Photo')->findAll();
     ...
     * @Method("POST")
     * @Template("FrontOfficeOptimusBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrontOfficeOptimusBundle:Photo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FrontOfficeOptimusBundle:Photo:edit.html.twig")
     */
